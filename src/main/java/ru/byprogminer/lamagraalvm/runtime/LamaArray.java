...
public record LamaArray(Object[] values) implements TruffleObject {
    ...
    static final class ReadArrayElement {
        ...
        static Object readArrayElementInBounds(LamaArray value, long index) {
    ...
    static final class IsIdenticalOrUndefined {
        ...
        @Specialization
        static TriState isIdentical(LamaArray a, LamaArray b) {
            return TriState.valueOf(a == b);
        }

        @Fallback
        static TriState isIdentical(LamaArray a, Object b) {
